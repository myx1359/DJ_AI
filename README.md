...
- [系统概述](#系统概述){#toc-系统概述}
  - [系统定位](#系统定位){#toc-系统定位}
  - [核心功能说明](#核心功能说明){#toc-核心功能说明}
  - [系统登录](#系统登录){#toc-系统登录}
- [用户管理](#用户管理){#toc-用户管理}
  - [用户管理](#用户管理-1){#toc-用户管理-1}
  - [机构管理](#机构管理){#toc-机构管理}
  - [角色管理](#角色管理){#toc-角色管理}
- [党员评价](#党员评价){#toc-党员评价}
  - [PC端](#pc端){#toc-pc端}
    - [数据管理](#数据管理){#toc-数据管理}
      - [数据管理首页](#数据管理首页){#toc-数据管理首页}
      - [数据管理-评价时段-添加](#数据管理-评价时段-添加){#toc-数据管理-评价时段-添加}
      - [数据管理-评价时段-编辑、删除](#数据管理-评价时段-编辑删除){#toc-数据管理-评价时段-编辑删除}
      - [数据导入页面](#数据导入页面){#toc-数据导入页面}
      - [数据编辑页面](#数据编辑页面){#toc-数据编辑页面}
      - [生成评价报告](#生成评价报告){#toc-生成评价报告}
    - [评价结果](#评价结果){#toc-评价结果}
      - [评价报告-查看](#评价报告-查看){#toc-评价报告-查看}
      - [评价报告-导出](#评价报告-导出){#toc-评价报告-导出}
      - [评价报告-撤回](#评价报告-撤回){#toc-评价报告-撤回}
  - [小程序端](#小程序端){#toc-小程序端}
    - [个人信息完善](#个人信息完善){#toc-个人信息完善}
    - [考核评价报告首页](#考核评价报告首页){#toc-考核评价报告首页}
    - [评价报告明细-学院党委](#评价报告明细-学院党委){#toc-评价报告明细-学院党委}
    - [评价报告明细-二级支部](#评价报告明细-二级支部){#toc-评价报告明细-二级支部}
    - [评价报告明细-党员个人](#评价报告明细-党员个人){#toc-评价报告明细-党员个人}
- [党群组织管理](#党群组织管理){#toc-党群组织管理}
  - [党群组织管理](#党群组织管理-1){#toc-党群组织管理-1}
    - [新增党组织、团组织](#新增党组织团组织){#toc-新增党组织团组织}
    - [查看组织](#查看组织){#toc-查看组织}
    - [编辑组织](#编辑组织){#toc-编辑组织}
    - [开启、停用组织](#开启停用组织){#toc-开启停用组织}
    - [删除组织](#删除组织){#toc-删除组织}
- [党员基础信息管理](#党员基础信息管理){#toc-党员基础信息管理}
- [党员发展管理](#党员发展管理){#toc-党员发展管理}
  - [登录并完善个人基本信息](#登录并完善个人基本信息){#toc-登录并完善个人基本信息}
  - [入党申请书递交](#入党申请书递交){#toc-入党申请书递交}
    - [申请人（小程序端）](#申请人小程序端){#toc-申请人小程序端}
    - [党支部管理员（PC端）](#党支部管理员pc端){#toc-党支部管理员pc端}
  - [入党申请书审核](#入党申请书审核){#toc-入党申请书审核}
    - [党支部管理员（PC端）](#党支部管理员pc端-1){#toc-党支部管理员pc端-1}
  - [党组织派人谈话](#党组织派人谈话){#toc-党组织派人谈话}
    - [党支部管理员（PC端）](#党支部管理员pc端-2){#toc-党支部管理员pc端-2}
    - [谈话人（小程序端）](#谈话人小程序端){#toc-谈话人小程序端}
  - [申请人公示](#申请人公示){#toc-申请人公示}
    - [党支部管理员（PC端）](#党支部管理员pc端-3){#toc-党支部管理员pc端-3}
  - [确定符合条件的申请人](#确定符合条件的申请人){#toc-确定符合条件的申请人}
    - [党支部管理员（PC端）](#党支部管理员pc端-4){#toc-党支部管理员pc端-4}
  - [团支部推优/党员推优](#团支部推优党员推优){#toc-团支部推优党员推优}
    - [申请人（小程序端）](#申请人小程序端-1){#toc-申请人小程序端-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-5){#toc-党支部管理员pc端-5}
  - [入党积极分子名单公示](#入党积极分子名单公示){#toc-入党积极分子名单公示}
    - [党支部管理员（PC端）](#党支部管理员pc端-6){#toc-党支部管理员pc端-6}
  - [填报支委会议时间](#填报支委会议时间){#toc-填报支委会议时间}
    - [党支部管理员（PC端）](#党支部管理员pc端-7){#toc-党支部管理员pc端-7}
  - [上级党委备案](#上级党委备案){#toc-上级党委备案}
    - [党支部管理员（PC端）](#党支部管理员pc端-8){#toc-党支部管理员pc端-8}
    - [学院党委（PC端）](#学院党委pc端){#toc-学院党委pc端}
  - [指定培养联系人及公示](#指定培养联系人及公示){#toc-指定培养联系人及公示}
    - [党支部管理员（PC端）](#党支部管理员pc端-9){#toc-党支部管理员pc端-9}
  - [培育考察](#培育考察){#toc-培育考察}
    - [入党积极分子（小程序端）](#入党积极分子小程序端){#toc-入党积极分子小程序端}
    - [培养联系人（小程序端）](#培养联系人小程序端){#toc-培养联系人小程序端}
    - [党支部管理员（PC端）](#党支部管理员pc端-10){#toc-党支部管理员pc端-10}
    - [学院党委管理员（PC端）](#学院党委管理员pc端){#toc-学院党委管理员pc端}
  - [确定符合条件的积极分子](#确定符合条件的积极分子){#toc-确定符合条件的积极分子}
    - [党支部管理员（PC端）](#党支部管理员pc端-11){#toc-党支部管理员pc端-11}
  - [团支部推优/党员推优](#团支部推优党员推优-1){#toc-团支部推优党员推优-1}
    - [申请人（小程序端）](#申请人小程序端-2){#toc-申请人小程序端-2}
    - [党支部管理员（PC端）](#党支部管理员pc端-12){#toc-党支部管理员pc端-12}
  - [入党重点发展对象座谈会](#入党重点发展对象座谈会){#toc-入党重点发展对象座谈会}
    - [党支部管理员（PC端）](#党支部管理员pc端-13){#toc-党支部管理员pc端-13}
  - [支委会议](#支委会议){#toc-支委会议}
    - [党支部管理员（PC端）](#党支部管理员pc端-14){#toc-党支部管理员pc端-14}
  - [上级党委备案](#上级党委备案-1){#toc-上级党委备案-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-15){#toc-党支部管理员pc端-15}
    - [学院党委（PC端）](#学院党委pc端-1){#toc-学院党委pc端-1}
  - [确定入党重点发展对象名单的公示](#确定入党重点发展对象名单的公示){#toc-确定入党重点发展对象名单的公示}
    - [学院党委（PC端）](#学院党委pc端-2){#toc-学院党委pc端-2}
  - [确定入党介绍人](#确定入党介绍人){#toc-确定入党介绍人}
    - [党支部管理员（PC端）](#党支部管理员pc端-16){#toc-党支部管理员pc端-16}
  - [入党教育培育考察](#入党教育培育考察){#toc-入党教育培育考察}
    - [发展对象（小程序端）](#发展对象小程序端){#toc-发展对象小程序端}
    - [入党介绍人（小程序端）](#入党介绍人小程序端){#toc-入党介绍人小程序端}
    - [党支部管理员（PC端）](#党支部管理员pc端-17){#toc-党支部管理员pc端-17}
  - [政审管理](#政审管理){#toc-政审管理}
    - [学院党委（PC端）](#学院党委pc端-3){#toc-学院党委pc端-3}
    - [党支部管理员（PC端）](#党支部管理员pc端-18){#toc-党支部管理员pc端-18}
    - [发展对象（小程序端）](#发展对象小程序端-1){#toc-发展对象小程序端-1}
  - [党校培训](#党校培训){#toc-党校培训}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-1){#toc-学院党委管理员pc端-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-19){#toc-党支部管理员pc端-19}
  - [确定符合条件的发展对象](#确定符合条件的发展对象){#toc-确定符合条件的发展对象}
    - [党支部管理员（PC端）](#党支部管理员pc端-20){#toc-党支部管理员pc端-20}
  - [流转座谈会及谈话](#流转座谈会及谈话){#toc-流转座谈会及谈话}
    - [入党介绍人（小程序端）](#入党介绍人小程序端-1){#toc-入党介绍人小程序端-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-21){#toc-党支部管理员pc端-21}
  - [预备党员接收公示](#预备党员接收公示){#toc-预备党员接收公示}
    - [党支部管理员（PC端）](#党支部管理员pc端-22){#toc-党支部管理员pc端-22}
  - [支委会议](#支委会议-1){#toc-支委会议-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-23){#toc-党支部管理员pc端-23}
  - [上级党委预审](#上级党委预审){#toc-上级党委预审}
    - [党支部管理员（PC端）](#党支部管理员pc端-24){#toc-党支部管理员pc端-24}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-2){#toc-学院党委管理员pc端-2}
  - [入党志愿书管理](#入党志愿书管理){#toc-入党志愿书管理}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-3){#toc-学院党委管理员pc端-3}
    - [发展对象（小程序端）](#发展对象小程序端-2){#toc-发展对象小程序端-2}
    - [党支部管理员（PC端）](#党支部管理员pc端-25){#toc-党支部管理员pc端-25}
  - [支部大会讨论](#支部大会讨论){#toc-支部大会讨论}
    - [党支部管理员（PC端）](#党支部管理员pc端-26){#toc-党支部管理员pc端-26}
    - [发展对象（小程序端）](#发展对象小程序端-3){#toc-发展对象小程序端-3}
  - [上级党委派人谈话](#上级党委派人谈话){#toc-上级党委派人谈话}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-4){#toc-学院党委管理员pc端-4}
    - [预备党员（小程序端）](#预备党员小程序端){#toc-预备党员小程序端}
  - [上级党委审批](#上级党委审批){#toc-上级党委审批}
    - [党支部管理员（PC端）](#党支部管理员pc端-27){#toc-党支部管理员pc端-27}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-5){#toc-学院党委管理员pc端-5}
  - [再上一级党委组织部门备案](#再上一级党委组织部门备案){#toc-再上一级党委组织部门备案}
  - [编入党支部和党小组](#编入党支部和党小组){#toc-编入党支部和党小组}
    - [党支部管理员（PC端）](#党支部管理员pc端-28){#toc-党支部管理员pc端-28}
  - [入党宣誓](#入党宣誓){#toc-入党宣誓}
    - [党支部管理员（PC端）](#党支部管理员pc端-29){#toc-党支部管理员pc端-29}
  - [转正教育考察](#转正教育考察){#toc-转正教育考察}
    - [预备党员（小程序端）](#预备党员小程序端-1){#toc-预备党员小程序端-1}
    - [入党介绍人（小程序端）](#入党介绍人小程序端-2){#toc-入党介绍人小程序端-2}
    - [党支部管理员（PC端）](#党支部管理员pc端-30){#toc-党支部管理员pc端-30}
  - [提出转正申请](#提出转正申请){#toc-提出转正申请}
    - [党支部管理员（PC端）](#党支部管理员pc端-31){#toc-党支部管理员pc端-31}
    - [预备党员（小程序端）](#预备党员小程序端-2){#toc-预备党员小程序端-2}
  - [座谈会管理](#座谈会管理){#toc-座谈会管理}
    - [党支部管理员（PC端）](#党支部管理员pc端-32){#toc-党支部管理员pc端-32}
  - [预备党员转正公示](#预备党员转正公示){#toc-预备党员转正公示}
    - [党支部管理员（PC端）](#党支部管理员pc端-33){#toc-党支部管理员pc端-33}
  - [上级党委预审](#上级党委预审-1){#toc-上级党委预审-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-34){#toc-党支部管理员pc端-34}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-6){#toc-学院党委管理员pc端-6}
  - [支部大会讨论](#支部大会讨论-1){#toc-支部大会讨论-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-35){#toc-党支部管理员pc端-35}
    - [发展对象（小程序端）](#发展对象小程序端-4){#toc-发展对象小程序端-4}
  - [上级党委审批](#上级党委审批-1){#toc-上级党委审批-1}
    - [党支部管理员（PC端）](#党支部管理员pc端-36){#toc-党支部管理员pc端-36}
    - [学院党委管理员（PC端）](#学院党委管理员pc端-7){#toc-学院党委管理员pc端-7}
  - [完成发展流程](#完成发展流程){#toc-完成发展流程}
    - [党支部管理员（PC端）](#党支部管理员pc端-37){#toc-党支部管理员pc端-37}
- [党员发展管理其他操作](#党员发展管理其他操作){#toc-党员发展管理其他操作}
  - [时间轴管理](#时间轴管理){#toc-时间轴管理}
    - [PC端](#pc端-1){#toc-pc端-1}
    - [小程序端](#小程序端-1){#toc-小程序端-1}
  - [消息](#消息){#toc-消息}
    - [PC端](#pc端-2){#toc-pc端-2}
    - [小程序端](#小程序端-2){#toc-小程序端-2}
...
[3.1.3 评价报告明细-学院党委 [22](#评价报告明细-学院党委)](#评价报告明细-学院党委)

[3.1.4 评价报告明细-二级支部 [24](#评价报告明细-二级支部)](#评价报告明细-二级支部)

[3.1.5 评价报告明细-党员个人 [25](#评价报告明细-党员个人)](#评价报告明细-党员个人)
...
[6.1.1 登录并完善个人基本信息 [34](#登录并完善个人基本信息)](#登录并完善个人基本信息)
...
[6.2.1 确定符合条件的申请人 [48](#确定符合条件的申请人)](#确定符合条件的申请人)

[6.2.2 团支部推优/党员推优 [49](#团支部推优党员推优)](#团支部推优党员推优)

[6.2.3 入党积极分子名单公示 [51](#入党积极分子名单公示)](#入党积极分子名单公示)

[6.2.4 填报支委会议时间 [52](#填报支委会议时间)](#填报支委会议时间)

[6.2.5 上级党委备案 [53](#上级党委备案)](#上级党委备案)

[6.2.6 指定培养联系人及公示 [56](#指定培养联系人及公示)](#指定培养联系人及公示)

[6.2.7 培育考察 [58](#培育考察)](#培育考察)

[第三节 入党重点发展对象的确定和培养教育阶段 [72](#_Toc21316)](#_Toc21316)

[6.3.1 确定符合条件的积极分子 [72](#确定符合条件的积极分子)](#确定符合条件的积极分子)

[6.3.2 团支部推优/党员推优 [73](#团支部推优党员推优-1)](#团支部推优党员推优-1)

[6.3.3 入党重点发展对象座谈会 [75](#入党重点发展对象座谈会)](#入党重点发展对象座谈会)

[6.3.4 支委会议 [77](#支委会议)](#支委会议)

[6.3.5 上级党委备案 [78](#上级党委备案-1)](#上级党委备案-1)

[6.3.6 确定入党重点发展对象名单的公示 [80](#确定入党重点发展对象名单的公示)](#确定入党重点发展对象名单的公示)
...
[6.4.1 确定符合条件的发展对象 [94](#确定符合条件的发展对象)](#确定符合条件的发展对象)
...
[6.4.10 再上一级党委组织部门备案 [116](#再上一级党委组织部门备案)](#再上一级党委组织部门备案)

[第五节 预备党员的教育考察和转正 [118](#_Toc21712)](#_Toc21712)

[6.5.1 编入党支部和党小组 [118](#编入党支部和党小组)](#编入党支部和党小组)
...
[第七章 党员发展管理其他操作 [135](#党员发展管理其他操作)](#党员发展管理其他操作)
